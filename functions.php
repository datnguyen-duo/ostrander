<?php
/**
 * ostrander functions and definitions
 *
 ...
 */
function ostrander_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on ostrander, use a find and replace
		* to change 'ostrander' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'ostrander', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'ostrander' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'ostrander_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'ostrander_setup' );
 ...
 */
function ostrander_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'ostrander_content_width', 640 );
}
add_action( 'after_setup_theme', 'ostrander_content_width', 0 );
 ...
 */
function ostrander_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'ostrander' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'ostrander' ),
...
add_action( 'widgets_init', 'ostrander_widgets_init' );
